...
################################################################################
setwd('/Users/jiaming/Desktop/cancer_m6A_predictor/file_m6Acancer_specificity')
################################################################################
############################      Data Analysis      ############################
################################################################################
# Load Raw Data
...
saveRDS(final_result, './final_result[cut_off=0.5].rds')
readRDS('./final_result[cut_off=0.5].rds')
